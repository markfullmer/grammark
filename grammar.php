...
echo '<br />';
if ($count >= 1) {
	echo '<img src="fail.png" style="display:inline; float:right;" alt="failed the test" /><p>Your writing has <b>';
	echo $gramspellcount;
