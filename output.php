...
// Output the text, highlighting stuff
	...
	echo '<p><b>Click on the text below to start editing</b></p>';
	...
	echo '<p><input class="btn" type="submit" name="submit" value="Recheck"/></p>'; 
	echo '</form>';
	...
	echo '<p><input class="btn" type="submit" name="submit" value="Save &amp; Download"/></p>'; 
	echo '</form>';
