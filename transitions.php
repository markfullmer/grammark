...
if (($count/$sentencecount*100) < $_SESSION['allowedtransitions']) { echo '<img src="fail.png" alt="Failed the criteria" style="float:right;" />'; }
else { echo '<img src="pass.png" alt="Passed the criteria" style="float:right;" />'; }
...
echo ' Read more about <a href="using-transitions.php">using transitions</a>.</p>'; 
echo '</div>';
?>