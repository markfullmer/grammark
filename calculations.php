...
if (isset($_POST['customize'])) { 
	...
	$_SESSION['allowedwordiness'] = $_POST['allowedwordiness'];

	$_SESSION['allowedgrammar'] = $_POST['allowedgrammar'];

	$_SESSION['allowedtransitions'] = $_POST['allowedtransitions'];

	$_SESSION['allowedandbutor'] = $_POST['allowedandbutor'];

	$_SESSION['allowedvariety'] = $_POST['allowedvariety'];

	$allowedpassive = $_SESSION['allowedpassive'];

	$allowedwordiness = $_SESSION['allowedwordiness'];

	$allowedgrammar = $_SESSION['allowedgrammar'];

	$allowedtransitions = $_SESSION['allowedtransitions'];

	$allowedandbutor = $_SESSION['allowedandbutor'];

	$allowedvariety = $_SESSION['allowedvariety'];
...
elseif (isset($_GET['preset']) && $_GET['preset'] == 'humanities') {
	...
	$_SESSION['allowedpassive'] = $allowedpassive;

	$_SESSION['allowedwordiness'] = $allowedwordiness;

	$_SESSION['allowedgrammar'] = $allowedgrammar;

	$_SESSION['allowedtransitions'] = $allowedtransitions;

	$_SESSION['allowedandbutor'] = $allowedandbutor;

	$_SESSION['allowedvariety'] = $allowedvariety;
