...
// Potential problems
echo '<div class="box" style="width:500px; float:left; margin-top:10px;">';
...
echo '</td></tr>';
echo '</table>';
echo '<div class="button" style="width:170px;text-align:center;margin:15px;float:left;"><a href="index.php?id=passive">Fix Problems</a></div>';
echo '<div class="button" style="width:150px;text-align:center;margin:15px;float:left;display:block;"><a href="index.php?id=start">Start Over</a></div>';
...
<div class="box" style="width:300px; display:block; float:left; margin-top:12px;">
...
<input class="btn" type="submit" name="customize" value="Customize" /> 
</form>
<p>
Presets: <a class="smallbutton" href="index.php?preset=humanities">Humanities</a> <a class="smallbutton" href="index.php?preset=sciences">Sciences</a> <a class="smallbutton" href="index.php?preset=internet">Web</a> <a class="smallbutton" href="index.php?preset=default">Default</a></p>
<p><a href="writing-types.php">More on these writing styles...</a></p>
</div>
