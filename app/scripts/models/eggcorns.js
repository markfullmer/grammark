...
var eggcorns = function() {
    this.machineName = 'eggcorns';
    this.title = 'Eggcorns';
    this.passingScore = '0';
    this.passingText = ' errors';
    this.scoringType = 'punitive';
    this.ratioType = 'errors';
    this.fail = 'Eggcorns are nonstandard versions of words or sayings that are very similar to the accepted form. Examples:<ul><li><mark>old-timers\' disease</mark> (Alzheimer\'s disease)</li><li><mark>all intensive purposes</mark> (all intents and purposes)</li><li><mark>mute point</mark> (moot point)</li></ul>Your writing may seem less professional or sophisticated when it contains eggcorns. Replace all of the below highlights with the standard form. See the <a href="#eggcorns">full list of eggcorns</a> checked.';
    this.pass = 'For the win! Your writing is free of eggcorns. See the <a href="#/resources/eggcorns">full list of eggcorns</a> checked.';
    this.markup = 'yellow';
    this.corrections = {
