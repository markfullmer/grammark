...
echo '<img src="fail.png" style="display:inline; float:right;" alt="failed the test" />';
...
echo '<img src="pass.png" style="float:right;" alt="pass the test" /><p>Your writing has <b>';
