...
if (($count/$sentencecount*100) > $_SESSION['allowedwordiness']) { echo '<img src="fail.png" alt="Failed the criteria" style="float:right;" />'; 
...
else { echo '<img src="pass.png" alt="Passed the criteria" style="float:right;" /> Your writing has <b>'; 
echo $count;
